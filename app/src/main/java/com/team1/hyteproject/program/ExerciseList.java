...
public class ExerciseList {
    ...
    private ExerciseList() {
        ...
        upperBodyExercises.add(new BaseExercise("Bicep Curl", 5, 5, 3,true, TargetMuscleGroup.BICEPS, ExerciseGroup.UPPER_BODY));
        upperBodyExercises.add(new BaseExercise("Cable Rope Tricep Pushdown", 5, 5, 3,true, TargetMuscleGroup.TRICEPS, ExerciseGroup.UPPER_BODY));
        upperBodyExercises.add(new BaseExercise("Calf raise", 5, 5, 3,true, TargetMuscleGroup.CALVES, ExerciseGroup.UPPER_BODY));
        upperBodyExercises.add(new BaseExercise("Standing Dumbell Raise", 5, 5, 3,true, TargetMuscleGroup.DELTS, ExerciseGroup.UPPER_BODY));
